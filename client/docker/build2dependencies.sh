...
BASE_IMAGE_NAME="my-wifi-client:environment-latest"
...
docker build -f ./client/docker/dockerfiles/$DOCKERFILE_NAME -t "$IMAGE_NAME:$TAG2" --build-arg BASE_IMAGE="$BASE_IMAGE_NAME" .